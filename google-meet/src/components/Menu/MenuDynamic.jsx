        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', flexBasis: '66%' }}>
            ...
            <div className="menu-container">
                <div style={{ display: 'flex' }}>
                    ...
                    {/* microphone */}
                    <p onClick={() => setOnOff({ ...onOff, microphone: !(onOff.microphone) })} style={{ backgroundColor: onOff.microphone && 'red' }}>{!onOff.microphone ? <svg className="center-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="20px"><path d="M192 0C139 0 96 43 96 96V256c0 53 43 96 96 96s96-43 96-96V96c0-53-43-96-96-96zM64 216c0-13.3-10.7-24-24-24s-24 10.7-24 24v40c0 89.1 66.2 162.7 152 174.4V464H120c-13.3 0-24 10.7-24 24s10.7 24 24 24h72 72c13.3 0 24-10.7 24-24s-10.7-24-24-24H216V430.4c85.8-11.7 152-85.3 152-174.4V216c0-13.3-10.7-24-24-24s-24 10.7-24 24v40c0 70.7-57.3 128-128 128s-128-57.3-128-128V216z" /></svg>
                    ...
                    {/* camera */}
                    <p onClick={() => setOnOff({ ...onOff, camera: !(onOff.camera) })} style={{ backgroundColor: onOff.camera && 'red' }}>{!onOff.camera ? <svg className="center-svg" width="26px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" ><path d="M0 128C0 92.7 28.7 64 64 64H320c35.3 0 64 28.7 64 64V384c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128zM559.1 99.8c10.4 5.6 16.9 16.4 16.9 28.2V384c0 11.8-6.5 22.6-16.9 28.2s-23 5-32.9-1.6l-96-64L416 337.1V320 192 174.9l14.2-9.5 96-64c9.8-6.5 22.4-7.2 32.9-1.6z" /></svg>
                    ...
                    <p><svg className="center-svg " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" width="26px"><path d="M601.2 5.1c10.4-8.2 25.5-6.3 33.7 4.1s6.3 25.5-4.1 33.7l-592 464c-10.4 8.2-25.5 6.3-33.7-4.1s-6.3-25.5 4.1-33.7l155.6-122C101.8 270 64 171.4 64 64c0-18 12.1-33.8 29.5-38.6l88-24c19.4-5.3 39.7 4.6 47.4 23.2l40 96c6.8 16.3 2.1 35.2-11.6 46.3L208 207.3c12 25.5 27.2 49.2 45 70.7L601.2 5.1zM234.3 415.6l91.3-72c13.7 9.1 28 17.3 43 24.3L409 318.7c11.2-13.7 30-18.4 46.3-11.6l96 40c18.6 7.7 28.5 28 23.2 47.4l-24 88C545.8 499.9 530 512 512 512c-104.9 0-201.3-36-277.7-96.4z" /></svg></p>
                </div>
